...
class ExternalContentTest {
  ...
  void testBuildingExternalContent() {
    ...
    externalContentBuilder.addDitaReference(
    ...
    externalContentBuilder.addTextReplacement(
        UUID.randomUUID().toString(), UUID.randomUUID().toString());
    externalContentBuilder.addTextReplacement(
        UUID.randomUUID().toString(), UUID.randomUUID().toString());
    externalContentBuilder.addTextReplacement(
  ...
  void testIntegrationOfContentAndExternalContent() {
    ...
    final CheckContent checkContent =
        new CheckContent("<xml>This \"is a sentence.</xml>\n<t>tests</t>", externalContent);
