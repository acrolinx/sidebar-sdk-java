...
public class AcrolinxSidebarInitParameter {
  ...
  AcrolinxSidebarInitParameter(
      final AcrolinxSidebarInitParameterBuilder acrolinxSidebarInitParameterBuilder) {
    ...
    this.clientComponents.stream()
        .forEach(component -> logger.info("Software component: {}", component));
    ...
    logger.info(
        "Plugin running on Java VM Version: {}", SidebarUtils.getFullCurrentJavaVersionString());
    ...
    if (this.minimumJavaVersion != 0) {
      ...
      if (SidebarUtils.getSystemJavaVersion() < this.minimumJavaVersion) {
        logger.warn(
            "The current Java version {} does not fulfill the requirements.",
  ...
  public static class AcrolinxSidebarInitParameterBuilder {
     ...
     * set, all others are optional.
     *
     * @param clientSignature This signature will be provided by Acrolinx once the integration got
     *     certified.
     * @param softwareComponents This contains id, name and version of the Acrolinx integration as
     *     well as other software components that where used.
     * @see SoftwareComponent
     */
    public AcrolinxSidebarInitParameterBuilder(
        final String clientSignature, final List<SoftwareComponent> softwareComponents) {
    ...
    /**
     * The url of the Acrolinx Sidebar. If this is not set the publicly available Sidebar will be
     * used by default.
     *
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    ...
    /**
     * If this parameter is set to 'true' the Acrolinx Sidebar will provide an input field to set an
     * url for the Acrolinx Server.
     *
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    public AcrolinxSidebarInitParameterBuilder withShowServerSelector(
        final Boolean showServerSelector) {
      this.showServerSelector = showServerSelector;
      return this;
    }
     ...
     * parameter is set, then the default check settings and the check settings saved by the user
     * will be ignored.
     *
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    public AcrolinxSidebarInitParameterBuilder withCheckSettings(
        final CheckSettings checkSettings) {
      this.checkSettings = checkSettings;
      return this;
    }

    /**
     * These check settings will be used as the initial check settings when the Acrolinx Sidebar is
     * used for the first time.
     *
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    public AcrolinxSidebarInitParameterBuilder withDefaultCheckSettings(
        final CheckSettings defaultCheckSettings) {
     ...
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    public AcrolinxSidebarInitParameterBuilder withEnableSingleSignOn(
        final boolean enableSingleSignOn) {
     ...
     * @return Returns the AcrolinxInitParameterBuilder for chaining.
     */
    public AcrolinxSidebarInitParameterBuilder withMinimumSidebarVersion(
        final String minimumSidebarVersion) {
