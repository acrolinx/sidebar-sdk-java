...
public final class Lookup {
  ...
  protected static Optional<IntRange> getCorrectedMatch(
      List<DiffMatchPatch.Diff> diffs,
      List<OffsetAlign> offsetAligns,
      int offsetStart,
      int offsetEnd) {
  ...
  public static Optional<Integer> getDiffOffsetPositionStart(
      List<OffsetAlign> offsetAligns, int offset) {
    Optional<OffsetAlign> first =
        offsetAligns.stream()
  ...
  public static Optional<Integer> getDiffOffsetPositionEnd(
      List<OffsetAlign> offsetAligns, int offset) {
    Optional<OffsetAlign> first =
        offsetAligns.stream()
            .filter(
