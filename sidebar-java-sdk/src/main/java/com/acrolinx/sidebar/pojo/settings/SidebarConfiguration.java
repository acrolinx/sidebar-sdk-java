...
public class SidebarConfiguration
{
     ...
     * This can be useful if the checked context shouldn't be modified by the Acrolinx Sidebar.
     *
     * @param readOnlySuggestions If set to `true` the suggestions won't be clickable and not modify the content.
     */
