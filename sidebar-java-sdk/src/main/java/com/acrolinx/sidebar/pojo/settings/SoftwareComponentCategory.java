...
{
    /**
     * There should be exactly one MAIN component. This information is used to identify your client
     * on the server. Version information about this components might be displayed more prominently.
     */
    MAIN,
    /**
